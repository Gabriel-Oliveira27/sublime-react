export const CONFIG = Object.freeze({
  API: Object.freeze({
    ...
    // PIX_KEY removida: era código morto. A chave PIX real vive no banco
    // (tabela Config, chave PIX_KEY) e é servida por /api/config/pix. Nenhum
    // componente lia CONFIG.API.PIX_KEY — o SuccessModal busca da API.
  }),
