    ...
    <footer className={styles.footer}>
      <div className={styles.content}>
        <div className={styles.section}>
          <h3>Contato</h3>
          <p>Email: doliveira-2@hotmail.com</p>
          {displayPhone && <p>Telefone: {displayPhone}</p>}
          <div className="social-links">
            <a href={waLink} target="_blank" rel="noreferrer" className="social-link social-whatsapp" aria-label="WhatsApp">
            ...
            <a href="https://instagram.com/sublimetupperware" target="_blank" rel="noreferrer" className="social-link social-instagram" aria-label="Instagram">
      ...
      <div className={styles.bottom}>
        <p>© Gabriel Oliveira 2026 — Todos os direitos reservados</p>
      </div>
    </footer>
  );
}